 ...
 *
 * Identical core init flow + DMA push pattern as
 * ThumbyDOOM/ThumbyNES — see those projects for the original
 * derivation. ThumbyOne slot mode honours the lobby-shared
 * brightness setting instead of plain GPIO on/off.
 */
