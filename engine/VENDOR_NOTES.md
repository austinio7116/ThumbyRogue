...
| `src/craft_blocks.c` | `bake_water_frame` recoloured from clear blue to **dank murky green** (`rgb565(22, 64+band, 40)`) — dungeon/crypt water should read as stagnant, not a swimming pool. | polish |
